...
export function EntryForm(props: {
  ...
  async function postEntry() {
    if (
      ...
      if (
        ...
        const entry = await finishDiaryEntry(storedSleepDiary.id, rest);
  ...
  return (
    <View style={{ alignItems: "center" }}>
      {sleepDiaryEntry.finished && (
        <Button
          variant="outlined"
          onClick={props.onAbort}
          style={{ width: "70%", padding: 5 }}
        >
          <Text style={styles.savebutton}>Avbryt</Text>
        </Button>
      )}
      ...
      {naps.length > 0 && hasNapped === "Ja" ? (
        <Text style={styles.text}>Noter ned tidspunkt for alle blundene</Text>
      ) : (
        <></>
      )}
      {naps.length > 0 && hasNapped === "Ja" ? (
      ...
      >
                ...
                string: sleepDiaryEntry.bedtime
                  ? "" +
                    (new Date(sleepDiaryEntry.bedtime).getHours() >= 10
                      ? new Date(sleepDiaryEntry.bedtime).getHours()
                      : "0" + new Date(sleepDiaryEntry.bedtime).getHours()) +
                    ":" +
                    (new Date(sleepDiaryEntry.bedtime).getMinutes() >= 10
                      ? new Date(sleepDiaryEntry.bedtime).getMinutes()
                      : "0" + new Date(sleepDiaryEntry.bedtime).getMinutes())
                  : "",
                valid: true,
              }}
            />
            ...
            <TimeField
              ...
              initialState={{
                string: sleepDiaryEntry.lights_out
                  ? "" +
                    (new Date(sleepDiaryEntry.lights_out).getHours() >= 10
                      ? new Date(sleepDiaryEntry.lights_out).getHours()
                      : "0" + new Date(sleepDiaryEntry.lights_out).getHours()) +
                    ":" +
                    (new Date(sleepDiaryEntry.lights_out).getMinutes() >= 10
                      ? new Date(sleepDiaryEntry.lights_out).getMinutes()
                      : "0" + new Date(sleepDiaryEntry.lights_out).getMinutes())
                  : "",
                valid: true,
              }}
        ...
        numberOfNightWakes.value <= 30 ? (
          [...Array(numberOfNightWakes.value || 0).keys()].map((n) => (
            <Card key={n} style={{ maxWidth: "100%", padding: 5, margin: 0 }}>
              <TextField
                style={styles.textfield}
                placeholderText="          "
                keyboardType="numeric"
                ...
                string: sleepDiaryEntry.waketime
                  ? "" +
                    (new Date(sleepDiaryEntry.waketime).getHours() >= 10
                      ? new Date(sleepDiaryEntry.waketime).getHours()
                      : "0" + new Date(sleepDiaryEntry.waketime).getHours()) +
                    ":" +
                    (new Date(sleepDiaryEntry.waketime).getMinutes() >= 10
                      ? new Date(sleepDiaryEntry.waketime).getMinutes()
                      : "0" + new Date(sleepDiaryEntry.waketime).getMinutes())
                  : "",
                valid: true,
              }}
              baseDate={wakeDate}
                ...
                string: sleepDiaryEntry.risetime
                  ? "" +
                    (new Date(sleepDiaryEntry.risetime).getHours() >= 10
                      ? new Date(sleepDiaryEntry.risetime).getHours()
                      : "0" + new Date(sleepDiaryEntry.risetime).getHours()) +
                    ":" +
                    (new Date(sleepDiaryEntry.risetime).getMinutes() >= 10
                      ? new Date(sleepDiaryEntry.risetime).getMinutes()
                      : "0" + new Date(sleepDiaryEntry.risetime).getMinutes())
                  : "",
                valid: true,
              }}
              baseDate={riseDate}
        ...
        />
        <Button
          style={{ width: "70%", marginBottom: 30, padding: 5 }}
          variant="outlined"
          onClick={() => postEntry()}
