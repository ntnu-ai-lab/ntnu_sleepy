...
import { createUser, updateProfile } from "../../api/userApi";
    ...
    flow
      ? newKratosSdk(project)
          ...
          .then((s) => {
            ...
            createUser({}, s.session.identity.id).then((r) => {
              updateProfile(user, s.session.identity.id).then((re) => {
                if (r && re) setThisUser({ ...r, ...re });
              });
            });
          })
          .catch(
